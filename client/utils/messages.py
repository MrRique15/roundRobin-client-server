...
class MessagesContainer():
    ...
    def full_message_process(self, indx, message_body, client_socket) -> dict:    
        ...
        self.process_and_send_message(message_body=message_body, client_socket=client_socket)
        ...
        print(f"Time to process message [{indx + 1}]: {round((end_time - initial_time) * 1000, 2)} ms")
